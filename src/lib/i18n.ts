...
export const translations = {
  en: {
    ...
    edit_pending_description: 'You can modify the complimentary transfer status before confirming.',
  ...
  fr: {
    ...
    edit_pending_description: 'Vous pouvez modifier le statut du transfert offert avant la confirmation.',
