...
export const translations = {
  en: {
    ...
    select_riad: 'Select Your Riad',
    reservation_lookup: 'Find Your Reservation',
    reservation_id_label: 'Cloudbeds Reservation ID',
    reservation_id_placeholder: 'Enter your reservation ID',
  ...
  fr: {
    ...
    select_riad: 'Sélectionnez Votre Riad',
    reservation_lookup: 'Trouvez Votre Réservation',
    reservation_id_label: 'ID de réservation Cloudbeds',
    reservation_id_placeholder: 'Entrez votre ID de réservation',
