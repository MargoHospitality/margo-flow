...
export const translations = {
  en: {
    ...
    edit_pending_request: 'Edit Request',
    complimentary_transfer_label: 'Complimentary Transfer',
    recalculated_price: 'Recalculated Price',
    edit_pending_description: 'Adjust the transport details before you confirm the request.',
    price_will_be_recalculated: 'Price will be recalculated based on transport details.',
    transport_specific_details: 'Transport-specific details',
    complimentary_transfer_hint: 'The transport will be treated as complimentary.',
    manual_rate_hint: 'You can keep the suggested price or override it manually.',
    ...
    // Return to Guest App
    return_to_checkin: 'Back to Check-in',
    return_to_guest_app: 'Back to Guest App',
  },
  fr: {
    // Common
    app_name: 'MargoFlow',
    ...
    ferry_company: 'Compagnie de Ferry',
    ...
    edit_pending_request: 'Modifier la Demande',
    complimentary_transfer_label: 'Transfert Offert',
    recalculated_price: 'Prix Recalculé',
    edit_pending_description: 'Ajustez les détails du transport avant de confirmer la demande.',
    price_will_be_recalculated: 'Le prix sera recalculé selon les détails du transport.',
    transport_specific_details: 'Détails propres au transport',
    complimentary_transfer_hint: 'Le transport sera traité comme offert.',
    manual_rate_hint: 'Vous pouvez garder le prix suggéré ou le modifier manuellement.',
    use_suggested_price: 'Utiliser le prix suggéré',
    rate_label: 'Tarif (MAD)',
    ...
    // Return to Guest App
    return_to_checkin: 'Retour à l\'enregistrement',
    return_to_guest_app: 'Retour à la Guest App',
  }
} as const;
